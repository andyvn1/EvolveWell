      ...
      <main className="w-full">
        ...
        <section className="bg-white px-4 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-lg border-2 border-lime-200 bg-gradient-to-br from-blue-50 to-purple-50 p-8 text-center sm:p-12">
        ...
        <section id="trainers" className="bg-white px-4 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl">
            <div className="flex items-center justify-between">
              ...
              <Link href="/trainers" className="font-semibold text-lime-600 hover:text-lime-700">
                Meet more trainers →
              </Link>
            </div>
            ...
            <div className="grid gap-12 md:grid-cols-2">
              <div>
                ...
                <Link
                  ...
                  className="mt-8 inline-block rounded-full bg-lime-500 px-8 py-3 font-semibold text-white hover:bg-lime-600 transition-colors"
                >
        ...
        <section className="bg-gray-50 px-4 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 text-center">
              <Link
                href="/programs"
                className="inline-block rounded-full bg-lime-500 px-8 py-3 font-semibold text-white hover:bg-lime-600 transition-colors"
              >
                Browse All Programs
              </Link>
            </div>
        ...
        <section className="bg-white px-4 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg bg-lime-50 p-8 text-center">
        ...
        {/* CTA SECTION */}
        <section className="bg-gradient-to-r from-lime-500 to-lime-700 px-4 py-16 text-center text-white sm:py-20">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
              <Link
                href="/trainers"
                className="rounded-full bg-white px-8 py-3 font-semibold text-lime-600 hover:bg-gray-100 transition-colors"
              >
                Find a Trainer
              </Link>
              <a
