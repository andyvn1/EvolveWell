  ...
  return (
    <>
      ...
      <main className="w-full">
        {/* Hero with Image */}
        <div className="relative h-64 w-full bg-gradient-to-r from-lime-500 to-lime-700 sm:h-80">
          <Image
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {trainer.specialties.map((spec, i) => (
                    <span key={i} className="inline-block rounded-full bg-lime-100 px-4 py-1 text-sm font-medium text-lime-700">
                      {spec}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  <Link
                    ...
                    className="rounded-lg bg-lime-500 px-6 py-3 font-semibold text-white hover:bg-lime-600 transition-colors text-center"
                  >
                    Reserve a Session
                  </Link>
                  <button
            ...
            <div className="mt-12 grid gap-12 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2">
                ...
                <section className="mb-12">
                  ...
                  <Link
                    href={`/book/${trainer.id}`}
                    className="mt-4 block rounded-lg bg-lime-500 px-4 py-2 text-center font-semibold text-white hover:bg-lime-600 transition-colors"
                  >
                    Book a Session
                  </Link>
                </section>
