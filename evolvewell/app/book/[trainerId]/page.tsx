      ...
      <main className="w-full min-h-screen bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mb-12 flex items-center justify-center gap-4">
            <div className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${step === 'time' || step === 'checkout' || step === 'confirmation' ? 'bg-lime-500' : 'bg-gray-300'}`}>
              1
            </div>
            <div className={`h-1 flex-1 ${step === 'checkout' || step === 'confirmation' ? 'bg-lime-500' : 'bg-gray-300'}`} />
            <div className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${step === 'checkout' || step === 'confirmation' ? 'bg-lime-500' : 'bg-gray-300'}`}>
              2
            </div>
            <div className={`h-1 flex-1 ${step === 'confirmation' ? 'bg-lime-500' : 'bg-gray-300'}`} />
            <div className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${step === 'confirmation' ? 'bg-lime-500' : 'bg-gray-300'}`}>
              3
            </div>
          </div>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
              ...
              <div className="mt-8">
                ...
                <select
                  ...
                  className="mt-3 w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-black focus:border-lime-500 focus:outline-none"
                >
              ...
              {selectedDate && selectedTime && (
                <div className="mt-8 rounded-lg bg-lime-50 p-6">
                  ...
                  <div className="mt-3 space-y-2 text-gray-700">
                    ...
                    <p className="border-t border-lime-200 pt-2 text-lg font-bold">
              ...
              <div className="mt-8 flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 rounded-lg bg-lime-500 py-3 font-semibold text-white hover:bg-lime-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
                  Continue to Payment
                </button>
              </div>
            ...
            <div className="rounded-lg bg-white p-8 shadow-sm">
                ...
                <div className="mt-4 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2 text-black focus:border-lime-500 focus:outline-none"
                    />
                  </div>
                  <div>
              ...
              <div className="mt-8 flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 rounded-lg bg-lime-500 py-3 font-semibold text-white hover:bg-lime-600 transition-colors"
                >
                  Complete Booking
                </button>
              </div>
          ...
          {step === 'confirmation' && bookingConfirmed && (
            <div className="rounded-lg bg-white p-8 text-center shadow-sm">
              ...
              <div className="mt-8 rounded-lg bg-lime-50 p-6 text-left">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/"
                  className="flex-1 rounded-lg bg-lime-500 py-3 font-semibold text-white hover:bg-lime-600 transition-colors text-center"
                >
                  Back to Home
                </Link>
              </div>
