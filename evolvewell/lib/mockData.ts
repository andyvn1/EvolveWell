...
export const products = [
  ...
  { id: "3", name: "Resistance Band Set", price: 29.99, description: "5-piece set with varying resistance levels.", imageUrl: "https://images.unsplash.com/photo-1616803689943-5601631c7fec?w=400&h=300&fit=crop&auto=format", category: "Accessories" },
  { id: "4", name: "Foam Roller", price: 39.99, description: "High-density foam roller for recovery and mobility.", imageUrl: "https://images.unsplash.com/photo-1600881333168-2ef49b341f30?w=400&h=300&fit=crop&auto=format", category: "Recovery" },
